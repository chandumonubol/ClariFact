    ...
    return (
      <div className="text-center py-8">
        ...
        <button
          ...
          className="mt-4 inline-block px-4 py-2 bg-accent_primary text-white rounded-lg hover:bg-blue-600 transition-colors"
        >
          Go to History
        </button>
      </div>
      ...
      <div className="bg-white rounded-lg p-6 border border-border">
        <div className="mb-6">
          ...
          <div className="mt-3">
            ...
            <div className="w-full bg-bg_muted rounded-lg h-2.5 mt-1">
              <div
                className={`h-full rounded-lg bg-accent_primary ${analysis.confidence > 50 ? 'bg-accent_secondary' : ''} transition-colors`}
        ...
        <div className="mt-6">
          <button
            ...
            className="w-full py-2 bg-bg_muted text-text_primary rounded-lg hover:bg-bg_light transition-colors text-sm"
          >
            Go Back to History
          </button>
        </div>
